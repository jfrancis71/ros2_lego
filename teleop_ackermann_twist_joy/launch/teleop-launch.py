# This is essentially a copy of https://github.com/ros2/teleop_twist_joy/blob/rolling/launch/teleop-launch.py
# See License: https://github.com/ros2/teleop_twist_joy/blob/rolling/LICENSE.txt
    ...
    return launch.LaunchDescription([
        ...
        launch.actions.DeclareLaunchArgument('config_filepath', default_value=[
            launch.substitutions.TextSubstitution(text=os.path.join(
                get_package_share_directory('teleop_ackermann_twist_joy'), 'config', '')),
        ...
        launch_ros.actions.Node(
            package='teleop_ackermann_twist_joy', executable='teleop_node',
            name='teleop_ackermann_twist_joy_node',
