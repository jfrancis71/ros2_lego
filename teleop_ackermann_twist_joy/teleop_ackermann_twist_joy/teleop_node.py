...
#        super().__init__("teleop_node")
        ...
        self.axis_linear = self.get_parameter('axis_linear').get_parameter_value().integer_value
        ...
        self.scale_linear = self.get_parameter('scale_linear_turbo').get_parameter_value().double_value
        self.declare_parameter('axis_angular', 1)
